...
export class EducationComponent implements AfterViewInit {
  ...
  protected readonly education = signal<EducationEntry[]>([
    {
      period: '2023 — 2027',
      title: 'V.S.B Engineering College',
      subtitle: 'B.Tech — Information Technology (Karur, TN)',
      description: 'CGPA: 8.23 / 10 | Relevant Coursework: Data Structures & Algorithms, Object-Oriented Programming, DBMS, Operating Systems, Computer Networks, System Design Fundamentals',
    },
    {
      period: '2021 — 2023',
      title: 'Cheran Matriculation Higher Secondary School',
      subtitle: 'HSC — Science & Mathematics | Karur, TN',
      description: 'Completed Higher Secondary Certificate with strong grounding in Mathematics, Physics, Chemistry, and Computer Science fundamentals.',
    },
    {
      period: '2020 — 2021',
      title: 'Cheran Matriculation Higher Secondary School',
      subtitle: 'SSLC — General Academics | Karur, TN',
      description: 'Completed Secondary School Leaving Certificate with distinction in Science and Mathematics.',
    },
  ]);
