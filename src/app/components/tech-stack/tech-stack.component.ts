...
export class TechStackComponent implements AfterViewInit {
  ...
  protected readonly techStack = signal<TechItem[]>([
    ...
    { name: 'Claude AI API', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg' },
    { name: 'Git', icon: 'https://skillicons.dev/icons?i=git' },
    { name: 'GitHub', icon: 'https://skillicons.dev/icons?i=github' },
    { name: 'Postman', icon: 'https://skillicons.dev/icons?i=postman' },
    { name: 'Maven', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg' },
