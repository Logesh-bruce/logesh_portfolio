  ...
  template: `
    ...
    >
      ...
      >
        ...
        >
          <img src="assets/images/logo.png" alt="M.G. LOGESH logo" class="brand-logo-image" />
        </button>
        ...
        <div class="ml-auto hidden items-center gap-3 lg:flex">
          <a
            ...
            target="_blank"
            download="LOGESH_M_G_Resume.pdf"
            class="nav-link font-medium no-underline inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-white/10 hover:border-accent-teal/50 hover:text-accent-teal transition-all text-xs"
          >
      ...
      >
        <nav class="mx-4 mb-4 flex flex-col gap-1 rounded-2xl p-4 mobile-menu-inner">
          ...
          <a
            ...
            target="_blank"
            download="LOGESH_M_G_Resume.pdf"
            class="mobile-link text-center border border-accent-teal/30 text-accent-teal py-2 rounded-xl"
            (click)="closeMenu()"
          >
            Download Resume 📄
          </a>
