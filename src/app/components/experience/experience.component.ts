...
export class ExperienceComponent implements AfterViewInit {
  ...
  protected readonly experiences = signal<ExperienceEntry[]>([
    {
      company: 'UnitedHands Technologies Pvt Ltd',
      startDate: 'Dec 2025',
      endDate: 'Jan 2026',
      projects: [
        {
          title: 'ERP Backend System — Manufacturing Client',
          description:
            'Contributed to backend development of an ERP system for a gold-ornaments manufacturing client, supporting inventory, order, and production-tracking workflows.',
          techStack: ['Java', 'Spring Boot', 'SQL', 'REST APIs', 'Git'],
          githubUrl: 'https://github.com/Logesh-bruce',
          imageUrl: 'assets/images/unitedhands_erp.webp',
          imageAlt: 'ERP Backend System — UnitedHands Technologies',
        },
      ],
    },
    {
      ...
      projects: [
        {
          title: 'Java & Object-Oriented Design System',
          description:
            'Applied core object-oriented design principles (inheritance, encapsulation, polymorphism) across mentor-guided Java assignments, reinforcing exception handling and defensive coding.',
          techStack: ['Java', 'Object-Oriented Design', 'Exception Handling', 'Git'],
          githubUrl: 'https://github.com/Logesh-bruce',
          imageUrl: 'assets/images/infosys_ood.webp',
          imageAlt: 'Java & OOD — Infosys Springboard',
        },
      ],
    },
    {
      company: 'EtherinfoTech',
      startDate: 'Jun 2024',
      endDate: 'Jul 2024',
      projects: [
        {
          title: 'Responsive Web UI & REST API Integration',
          description:
            'Built and shipped responsive UI components integrated with backend REST APIs directly into live product features using Git-based version control workflows.',
          techStack: ['JavaScript', 'HTML5', 'CSS3', 'REST APIs', 'Git'],
          githubUrl: 'https://github.com/Logesh-bruce',
          imageUrl: 'assets/images/gogoenergy.webp',
          imageAlt: 'Web UI & REST API — EtherinfoTech',
        },
      ],
    },
  ]);
