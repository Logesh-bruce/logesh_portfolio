  ...
  protected readonly projects = signal<PersonalProject[]>([
    {
      title: 'PhishGuard AI',
      description:
        'Real-Time Phishing Detection & Prevention System combining client-side ML scoring with Claude AI-powered contextual analysis.',
      features: [
        'Dual-layer detection engine with sub-120ms latency for real-time threat protection',
        '20+ URL feature extractors (IP detection, TLD risk, brand spoofing, keyword signals)',
        'Weighted 0–100 risk-scoring model for accuracy and explainability',
        'Claude AI API integration for threat classification & remediation guidance',
      ],
      techStack: ['React.js', 'Claude AI API', 'ML Feature Eng.', 'Node.js', 'Cybersecurity'],
      githubUrl: 'https://github.com/Logesh-bruce',
      imageUrl: 'assets/images/phishguard.webp',
      imageAlt: 'PhishGuard AI — Real-Time Phishing Detection & Prevention System',
    },
    {
      title: 'EcoBazaar',
      description:
        'Full-Stack E-Commerce Platform built with Spring Boot, React.js, and PostgreSQL for end-to-end order lifecycle management.',
      features: [
        'Normalized relational schema in PostgreSQL with 15+ RESTful API endpoints',
        'Role-Based Access Control (RBAC) across User, Seller, and Admin roles',
        'Layered Controller–Service–Repository architecture for high scalability',
        'Validated REST API endpoints using Postman across role-based scenarios',
      ],
      techStack: ['React.js', 'Java', 'Spring Boot', 'PostgreSQL', 'REST APIs'],
      githubUrl: 'https://github.com/Logesh-bruce',
      imageUrl: 'assets/images/ecobazaar2.webp',
      imageAlt: 'EcoBazaar — Full-Stack E-Commerce Platform',
    },
  ]);
