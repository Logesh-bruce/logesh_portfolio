...
export class AchievementsComponent implements AfterViewInit {
  ...
  protected readonly achievements = signal<AchievementEntry[]>([
    {
      period: 'Apr 9 – 10, 2026',
      title: 'ORIGIN — 24-Hour Hackathon',
      subtitle: 'Team Lead — SIMATS Engineering, Chennai',
      description:
        'Owned end-to-end delivery of a working solution as Team Lead during a 24-hour hackathon, driving ideation, task delegation, and final demo under tight time constraints.',
      bullets: [
        'Led team ideation, system design, and task delegation under tight 24-hour constraints',
        'Engineered full-stack features and presented live demo to judges and technical panel',
        'Delivered complete functional prototype within full-day hackathon sprint',
      ],
      tags: ['Hackathon', 'Team Lead', 'SIMATS Engineering', 'Chennai'],
    },
    {
      period: '2024 — Present',
      title: 'DSA & Algorithmic Problem Solving',
      subtitle: '200+ Solved Problems — LeetCode',
      description:
        'Solved 200+ data structures and algorithms problems on LeetCode across Arrays, Strings, Trees, Graphs, and Dynamic Programming, strengthening algorithmic problem-solving and complexity analysis.',
      bullets: [
        'Solved 200+ algorithmic problems across Arrays, Strings, Trees, Graphs, and Dynamic Programming',
        'Strong focus on time and space complexity optimization (Big-O analysis)',
        'Consistently applying core data structures to optimize backend system performance',
      ],
      tags: ['LeetCode', 'DSA', 'Algorithms', 'Java'],
    },
    {
      period: '2025 — 2026',
      title: 'Industry & Academic Certifications',
      subtitle: 'AWS & NPTEL IIT Kharagpur',
      description:
        'Earned official certifications in Cloud Architecture and Java Programming from AWS and NPTEL IIT Kharagpur.',
      bullets: [
        'AWS Cloud Practitioner Essentials — AWS Training & Certification (Jul 2026)',
        'Programming in Java — NPTEL Certification, IIT Kharagpur (Jan – Apr 2025)',
      ],
      tags: ['AWS', 'Java', 'NPTEL', 'IIT Kharagpur', 'Cloud'],
    },
  ]);
